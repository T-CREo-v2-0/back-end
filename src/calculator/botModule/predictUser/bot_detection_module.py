...
# --------------------- NEW CODE FOR T-CREo ---------------------
class User:
    def __init__(self, user_follows, user_status, user_favorite, user_listed, user_friends):
        self.followers_count = user_follows
        self.statuses_count = user_status
        self.favourites_count = user_favorite
        self.listed_count = user_listed
        self.friends_count = user_friends

def predictUser(
        user_follows, user_status, user_favorite, 
        user_listed, user_friends, tweet_retweet, 
